export const areaConfig = Object.freeze({
  ...
  taichung: { position: { lat: 24.154712, lng: 120.664265 }, areaCode: '01', name: '臺中市' },
  // chcg: {position: { lat: 24.081666, lng: 120.538539 }, areaCode:'', name:''},
